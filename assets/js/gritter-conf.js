var Gritter = function () {
    ...
    $('#register-info').click(function(){

        $.gritter.add({
            // (string | mandatory) the heading of the notification
            title: 'Requested Information',
            // (string | mandatory) the text inside the notification
            text: 'All the information collected below is for analytical and demographic purposes only. We will never sell your any of your personal information.',
